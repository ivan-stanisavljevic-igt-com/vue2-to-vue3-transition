<template>
  <div class="payment__instrument">
    <span class="piitem-text">
      <h2 class="piitem-text-headline">{{ $t('Payments.Nuvei.Card.Headline') }}</h2>
      <div v-if="stepOne" class="piitem-text-desc">{{ $t('Payments.Nuvei.Card.Select') }}</div>
      <div v-if="stepTwo" class="piitem-text-desc">{{ $t('Payments.Nuvei.Card.Wd.Desc') }}</div>
    </span>
